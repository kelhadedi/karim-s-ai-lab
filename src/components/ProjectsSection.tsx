...
const projects = [
  {
    title: "Tests Utilisateurs JoMo",
    tools: "SUS · AttrakDiff · PANAs · Protocole UX",
    category: "UX Research",
    color: "from-[hsl(270,60%,70%)] to-[hsl(190,70%,60%)]",
    size: "md:col-span-2 md:row-span-2",
  },
  {
    title: "Stage Orange Business Services",
    tools: "Figma · IA · Design System",
    category: "UX/UI Design",
    color: "from-[hsl(30,90%,55%)] to-[hsl(50,70%,65%)]",
    size: "md:col-span-1 md:row-span-1",
  },
  {
    title: "Projets BUT MMI",
  ...
  },
  {
    ...
    tools: "Figma · Prototypage · Responsive",
    category: "Design System",
    color: "from-[hsl(190,70%,60%)] to-[hsl(220,60%,60%)]",
    size: "md:col-span-1 md:row-span-1",
  },
  {
    title: "Bénévolat FabLab Lannion",
    tools: "Prototypage · Communauté · Making",
    category: "Engagement",
    color: "from-[hsl(150,50%,55%)] to-[hsl(190,80%,55%)]",
    size: "md:col-span-1 md:row-span-1",
  },
];
